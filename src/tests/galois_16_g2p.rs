...
use crate::galois_16_g2p::{ReedSolomon, GF2p16};
...
quickcheck! {
    fn qc_encode_verify_reconstruct_verify(data: usize,
        ...
        {
            let mut refs =
                convert_2D_slices!(expect =>to_mut_vec &mut [u16]);
        ...
        ({
            let refs =
                convert_2D_slices!(expect =>to_vec &[u16]);
            ...
            ({
                let refs =
                    convert_2D_slices!(shards =>to_vec &[u16]);
    ...
    fn qc_encode_sep_same_as_encode(data: usize,
...

        {
            ...
            let data_refs =
                convert_2D_slices!(data =>to_mut_vec &[u16]);

            let mut parity_refs =
                convert_2D_slices!(parity =>to_mut_vec &mut [u16]);
    ...
    fn qc_encode_single_same_as_encode(data: usize,
        ...
        {
            let mut refs =
                convert_2D_slices!(shards =>to_mut_vec &mut [u16]);
    ...
    fn qc_encode_single_sep_same_as_encode(data: usize,
...

        {
            ...
            let data_refs =
                convert_2D_slices!(data_shards =>to_mut_vec &[u16]);

            let mut parity_refs =
                convert_2D_slices!(parity_shards =>to_mut_vec &mut [u16]);
